					...
					<div class="card">
						<div class="card-header">
							<div class="d-flex align-items-center">
								<h4 class="card-title">REPORTES DE TRASLADOS</h4>
							</div>
						</div>
						<div class="card-body">
							<form action="./reports/rango_fecha_empleado_traslados.php" method="post" target="_blank">
								<div class="row">
									<div class="col-md-3">
							...
							<form action="./reports/rango_fecha_empleado_tras.php" method="post" target="_blank">
								<div class="row">
									<div class="col-md-4">
										<div class="form-group">
